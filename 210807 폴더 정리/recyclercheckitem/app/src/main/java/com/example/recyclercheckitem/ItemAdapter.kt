...
import com.example.recyclercheckitem.databinding.ActivityListViewBinding
...
class ItemAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        var binding = ActivityListViewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    companion object {
        class ItemHolder(var binding: ActivityListViewBinding) : RecyclerView.ViewHolder(binding.root),
